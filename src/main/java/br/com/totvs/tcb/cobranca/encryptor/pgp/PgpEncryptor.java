...
public class PgpEncryptor {
    ...
    public PgpEncryptor(
        ...
        log.debug("Initialising encryptor");
    ...
    private void writeArmoredCipherText(
        ...
        log.debug("Encrypting with ASCII armour");
    ...
    private void writeToEncryptedOutput(
        ...
        log.debug("Initialised compressor");
        ...
        try (BCPGOutputStream bcpgOutputStream =
            ...
            log.debug("Created signature generator(s)");
            ...
            log.debug("Encoded one-pass signature(s)");

            writeLiteralData(inputStream, bcpgOutputStream, signatureGenerators);
            log.debug("Wrote literal data");
        ...
        try {
            ...
            while ((pgpObject = pgpObjectFactory.nextObject()) != null) {
                if (pgpObject instanceof PGPEncryptedDataList) {
                    log.debug("Finding decryptable data");
                    ...
                    log.debug("Finding verifiable one-pass signature");
                    ...
                    log.debug("Reading literal data");
    ...
    private boolean verifyAnySignature(
        ...
        Optional<PGPSignature> possibleSignature = Lists.newArrayList(signatures)
                ...
                .peek(signature ->
                        log.debug("One-pass matched signature of key: " + Long.toHexString(signature.getKeyID()))
                )
                .findAny();
