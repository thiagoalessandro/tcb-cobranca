...
public class ModelMapperUtils {
    ...
    public void loadModelMapperStrict() {
        ...
        modelMapperStrict.addConverter(convertMicroAmount, Long.class, BigDecimal.class);
    ...
    protected Converter<Long, BigDecimal> convertMicroAmount = context -> CfopUtils.convertMicroAmount(context.getSource());
